...
public partial class EnglishPremierLeague2024DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.FootballClubId).HasName("PK__Football__912795043B7FAA1F");
        ...
        {
            entity.HasKey(e => e.FootballPlayerId).HasName("PK__Football__6D5466C324E42C40");
        ...
        {
            entity.HasKey(e => e.AccId).HasName("PK__PremierL__91CBC398E9D109BF");

            entity.ToTable("PremierLeagueAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__PremierL__49A14740F8013DF0").IsUnique();
